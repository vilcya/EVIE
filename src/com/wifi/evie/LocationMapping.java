...
public class LocationMapping {
	...
	public String getLocation(ArrayList<String> userMacIds) {
		...
		for (int index = 0; index < locations.size(); index++) {
			if (overlap(userMacIds, locations.get(index))) {
				return this.locationNames[index];
			}
		}
	...
	private boolean overlap(ArrayList<String> userMacIds, Location location) {
		...
		Log.i("evie_debug", "overlap is " + overlap);
